      ...
      {!isCollapsed && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="border rounded-lg p-6 bg-white shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Search Operations Rate</h3>
            {isLoading ? (
              ...
              <TimeSeriesChart
                ...
                lines={[
                  { dataKey: 'Queries/sec', stroke: '#0891b2', name: 'Queries/sec' },
                ]}
                xAxisKey="timestamp"
          ...
          <div className="border rounded-lg p-6 bg-white shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Query Latency Percentiles</h3>
            {isLoading ? (
              <div className="h-64 flex items-center justify-center">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-cyan-600"></div>
              </div>
